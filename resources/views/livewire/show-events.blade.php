<div>
    ...
    <section data-section-id="3" data-share="" data-category="pricing" class="py-24 overflow-hidden">
        <div class="container px-4 mx-auto">
            <div class="mb-20 md:max-w-2xl text-center mx-auto">
                ...
                <p class="mb-12 text-gray-300 max-w-sm mx-auto" data-config-id="txt-1e2ea6-2">Proximos eventos, para ir a disfrutar de la chilena, zapateo, comida, copete y a,migos, no han de faltar</p>
            </div>
                        ...
                        <div class="relative px-8 pt-12 pb-12 h-full bg-gradient-radial-dark border-2 border-gray-900 border-opacity-30 overflow-hidden rounded-5xl">
                            ...
                            <div class="flex items-center mb-4">
                                <div class="flex items-center justify-center w-5 h-5 mr-4 rounded-full">
                                    <svg class="text-red-basic" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            ...
                            <a class="relative z-10 block px-14 py-4 text-center font-medium tracking-2xl border-2 border-red-basic bg-red-basic hover:bg-red-700 text-white focus:ring-4 focus:ring-red-800 focus:ring-opacity-40 rounded-full transition duration-500" href="#">VER</a>
